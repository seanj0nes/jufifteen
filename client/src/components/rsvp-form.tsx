...
export function RsvpForm() {
  ...
  const handleSubmit = async (data: InsertRsvp) => {
    ...
    try {
      // Crear un FormData para enviar a formsubmit.co
      const formData = new FormData();
      formData.append('name', data.name);
      formData.append('celular', data.email);
      formData.append('asistencia', data.attending ? 'Sí' : 'No');
      formData.append('preferencias', data.dietaryRestrictions || 'Lo que venga');
      formData.append('micro', data.usesBus ? 'Sí' : 'No');
      formData.append('dni', data.dni || 'No proporcionado');
      formData.append('mensaje', data.message || 'Sin mensaje');
